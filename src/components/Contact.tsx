      ...
      <div className="flex flex-col sm:flex-row justify-center items-center gap-10">
        <div className="w-48 h-48 rounded-full bg-transparent group cursor-pointer [perspective:1000px]">
          <div className="relative [transform-style:preserve-3d] rounded-full group-hover:[transform:rotateY(180deg)] w-full h-full duration-1000">
            ...
            <div className="absolute w-full h-full border-2 rounded-full [backface-visibility:hidden] [transform:rotateY(180deg)] shadow-xl bg-green-500">
              <div className="flex flex-col items-center justify-center h-full w-full gap-3">
                <h1 className="text-2xl">Call</h1>
                <h1 className="text-xl text-white font-medium">Zenka</h1>
            ...
            <span className="absolute top-1.5 right-4 z-40 w-7 h-7 rounded-full bg-green-500 ring-2 ring-gray-50" />
            <span className="absolute top-1.5 right-4 z-40 w-7 h-7 rounded-full bg-green-500 animate-ping" />
          </div>
        </div>
      </div>
    </div>
